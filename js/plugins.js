$(function() {
    $(".oembed-video .thumb, .oembed-video .play").click(function() {
        var a = $(this).parent()
          , b = a.find("iframe, object");
        b.attr("src", b.attr("data-src")),
        b.css({
            display: "block"
        }),
        a.find(".play, .thumb").remove()
    })
}),
!function(a, b) {
...
function(a, b) {
    ...
    function d(a) {
        this.parent = a,
        this.state = "stopped",
        f && (this.onVisibilityChange = function() {
    ...
    d.prototype.play = function() {
        if ("playing" != this.state) {
            var a = document[e];
            if (f && a)
                return void document.addEventListener(f, this.onVisibilityPlay);
            this.state = "playing",
            f && document.addEventListener(f, this.onVisibilityChange),
            this.tick()
        }
    }
    ,
    ...
    d.prototype.stop = function() {
        this.state = "stopped",
        this.clear(),
        f && document.removeEventListener(f, this.onVisibilityChange)
    }
    ,
    ...
    d.prototype.visibilityPlay = function() {
        this.play(),
        document.removeEventListener(f, this.onVisibilityPlay)
    }
    ,
    b.extend(c.defaults, {
