    ...
    var a = {
        init: function() {
            ...
            $(document).ready(function(b) {
                ...
                History.Adapter.bind(window, "statechange", function() {
                    ...
                    a.loadContent(d.url + "/ajax", c)) : "info" == e.type ? ($intro.remove(),
                    $body.addClass("info")) : ($body.removeClass("album info loading"),
                ...
                $('.info-btn [data-target]').bind('click', function(e) {
                    $el = $(this);
                    e.preventDefault();
                    History.pushState({
                        type: 'info'
        ...
        loadSlider: function() {
            ...
            $slider.on("select.flickity", function() {
                if ($('.is-selected').has('#myvid').length) {
                    $('#myvid').get(0).play();
                }
                else {
                    $('#myvid').get(0).pause();
                ...
                if ($('.is-selected').has('#myvid2').length) {
                    $('#myvid2').get(0).play();
                }
                else {
                    $('#myvid2').get(0).pause();
